...
async function main() {
 ...
 const tokenAddress = "0x84cba2A35398B42127B3148744DB3Cd30981fCDf";
  ...
  const bridge = Bridge.attach("0x67e0B3f4069e59812EecC65DF127811A43AF5Eb9");

    // console.log("setting bridge peer..");
    // await bridge.setPeer(destEid, "0x00000000000000000000000067e0B3f4069e59812EecC65DF127811A43AF5Eb9");
    // console.log("set!");

    // console.log("Whitelisting bridge token....");
    // await bridge.whitelistToken("0x43535C041AF9d270Bd7aaA9ce5313d960BBEABAD", "USDT");
  ...
  await token.approve("0x67e0B3f4069e59812EecC65DF127811A43AF5Eb9", amount);
